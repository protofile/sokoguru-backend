...
<html lang="en">
  ...
  <!-- ========== Css Files ========== -->
  <link href="<?=template_uri();?>css/root.css" rel="stylesheet">

  </head>
  <body>
  <!-- Start Page Loading -->
  <div class="loading"><img src="<?=template_uri();?>img/loading.gif" alt="loading-img"></div>
  <!-- End Page Loading -->
 ...
 <!-- //////////////////////////////////////////////////////////////////////////// --> 
  ...
  <div id="top" class="clearfix">
    ...
    <li class="dropdown link">
      <a href="#" data-toggle="dropdown" class="dropdown-toggle profilebox"><img src="<?=template_uri();?>img/profileimg.png" alt="img"><b>Jonathan Doe</b><span class="caret"></span></a>
  ...
  <div class="row presentation">
    ...
    <div class="col-lg-4 col-md-6">
      <ul class="list-unstyled list">
        ...
        <li><i class="fa fa-check"></i>Based on <a href="https://getbootstrap.com/docs/3.3/css/#tables" target="_blank">Bootstrap Tables</a><li>
      </ul>
    </div>
...
<div role="tabpanel" class="sidepanel">
  ...
  <div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane" id="chat">
      ...
      <ul class="group">
        <li class="member"><a href="#"><img src="<?=template_uri();?>img/profileimg.png" alt="img"><b>Allice Mingham</b>Los Angeles</a><span class="status online"></span></li>
        <li class="member"><a href="#"><img src="<?=template_uri();?>img/profileimg2.png" alt="img"><b>James Throwing</b>Las Vegas</a><span class="status busy"></span></li>
        <li class="member"><a href="#"><img src="<?=template_uri();?>img/profileimg3.png" alt="img"><b>Fred Stonefield</b>New York</a><span class="status away"></span></li>
        <li class="member"><a href="#"><img src="<?=template_uri();?>img/profileimg4.png" alt="img"><b>Chris M. Johnson</b>California</a><span class="status online"></span></li>
      </ul>

      <div class="gn-title">OFFLINE MEMBERS (8)</div>
     <ul class="group">
        <li class="member"><a href="#"><img src="<?=template_uri();?>img/profileimg5.png" alt="img"><b>Allice Mingham</b>Los Angeles</a><span class="status offline"></span></li>
        <li class="member"><a href="#"><img src="<?=template_uri();?>img/profileimg6.png" alt="img"><b>James Throwing</b>Las Vegas</a><span class="status offline"></span></li>
      </ul>
...
jQuery Library
================================================ -->
<script src="<?=template_uri();?>js/jquery.min.js"></script>

<!-- ================================================
Bootstrap Core JavaScript File
================================================ -->
<script src="<?=template_uri();?>js/bootstrap/bootstrap.min.js"></script>

<!-- ================================================
Plugin.js - Some Specific JS codes for Plugin Settings
================================================ -->
<script src="<?=template_uri();?>js/plugins.js"></script>
